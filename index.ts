 ...
 */
const hasParams = function (pathRegexp: any) {
...
const parseExpressPath = function (expressPathRegexp: any, params: any) {
...
const parseEndpoints = function (app: Regulus['server'], basePath?: string, endpoints?: any) {
